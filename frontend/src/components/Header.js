    ...
    <header className="bg-black shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            <div className="h-9 w-9 bg-gradient-to-r from-green-500 to-green-600 rounded-lg flex items-center justify-center text-white shadow-md">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link
              to="/"
              className="flex items-center text-white hover:text-green-600 transition-all duration-200 px-3 py-2 rounded-md hover:bg-green-50 font-medium"
            >
                ...
                {showGroupsDropdown && (
                  <div className="absolute right-0 mt-2 w-52 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10 transform transition-all duration-200">
                    <div className="py-1 rounded-md bg-white shadow-xs">
                      <Link
                        to="/groups"
                        className="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 transition-all duration-150"
            ...
            {isAuthenticated ? (
              <div className="relative" ref={dropdownProfileRef}>
                <button
                  ...
                  className="flex items-center space-x-3 text-white hover:text-green-600 transition-all duration-200 p-1 rounded-lg focus:outline-none"
                >
                  <div className="flex items-center space-x-2">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-r from-green-500 to-green-600 p-0.5 shadow-md">
              ...
              <div className="flex items-center space-x-3">
                <Link
                  to="/login"
                  className="px-4 py-2 text-green-600 font-medium hover:text-green-700 transition-colors duration-200"
                >
                  Log in
                </Link>
                <Link
                  to="/register"
                  className="px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-medium rounded-md shadow-sm hover:shadow transition-all duration-200"
                >
                  Register
                </Link>
              </div>
        ...
        <div className={`${mobileMenuOpen ? 'block' : 'hidden'} md:hidden transition-all duration-300 ease-in-out`}>
          <div className="px-2 pt-2 pb-4 space-y-1">
            <Link
              to="/"
              className="block px-3 py-2.5 rounded-md text-base font-medium text-white hover:text-green-600 hover:bg-green-50 transition-colors duration-200"
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/register"
                  className="block px-3 py-2.5 rounded-md text-base font-medium bg-green-600 text-white hover:bg-green-700 transition-colors duration-200"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Register
                </Link>
